...
public class WorkerManager : BaseManager<Worker>
{
    ...
    public async Task<CreateWorkerModel> CreateAsync(CreateWorkerModel model)
    {
    ...
    //işlevi: Etki alanı kuralını veya validasyonunu işletir.
    //sistemdeki görevi: Veri bütünlüğünü ve domain mantığını garanti altına alan düşük seviyeli operasyondur.
    public async Task<UpdateWorkerModel> UpdateAsync(Worker existing, UpdateWorkerModel model)
    {
