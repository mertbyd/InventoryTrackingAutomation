...
/// <summary>
/// Sevkiyat güncelleme domain modeli — Service'ten Manager'a taşınan veri taşıyıcı.
/// </summary>
public class UpdateShipmentModel
{
    ...
    public ShipmentStatusEnum Status { get; set; }       // Sevkiyat durumu. Örnek: ShipmentStatusEnum.InTransit
