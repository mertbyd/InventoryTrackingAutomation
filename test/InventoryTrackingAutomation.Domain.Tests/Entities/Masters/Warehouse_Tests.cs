...
/// <summary>
/// Warehouse entity audit ve aktiflik sozlesmesini dogrulayan testler.
/// </summary>
public class Warehouse_Tests
{
    [Fact]
    public void Should_Use_Update_Audit_Without_Soft_Delete()
    {
        // islevi: Warehouse master verisinin soft-delete kolonlari tasimadigini dogrular.
        // sistemdeki gorevi: Audit temizliklerinde Warehouse'in AuditedEntity seviyesinde kalmasini guvenceye alir.
