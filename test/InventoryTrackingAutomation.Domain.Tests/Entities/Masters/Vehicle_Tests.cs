...
/// <summary>
/// Vehicle entity audit ve aktiflik sozlesmesini dogrulayan testler.
/// </summary>
public class Vehicle_Tests
{
    ...
    {
        // islevi: Vehicle master verisinin soft-delete kolonlari tasimadigini dogrular.
        // sistemdeki gorevi: Audit temizliklerinde Vehicle'in AuditedEntity seviyesinde kalmasini guvenceye alir.
