...
public class InventoryTrackingAutomationWebHostMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public InventoryTrackingAutomationWebHostMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<InventoryTrackingAutomationResource>();
